...
const onsubmitForm = ()=>{
   ...
   const variables ={
    ...
    axios({
       method: 'post',
       url: '/shop/handleSaveSpecifications',
      data:variables
     
     
  }).then((response)=>{
   // console.log(response);
   // console.log(response.data.spec.title);
    const message = response.data.message;
    toast.success(message)
    const arrayHolder = [...allProductSpecs];
    arrayHolder.push({
        _id :response.data.spec._id,
         title :response.data.spec.title,
        label:response.data.spec.label
    });
